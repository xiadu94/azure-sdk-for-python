...
class GalleriesOperations(object):
    ...
    def list_by_resource_group(
        ...
        deserialized = models.GalleryPaged(internal_paging, self._deserialize.dependencies)

        if raw:
            header_dict = {}
            client_raw_response = models.GalleryPaged(internal_paging, self._deserialize.dependencies, header_dict)
            return client_raw_response
